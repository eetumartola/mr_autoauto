...
use crate::web::{should_disable_splats_for_platform, VirtualControlState};
...
const GROUND_STRIP_TEXTURE_PRIMARY_PATH: &str = "textures/ground_strip.png";
const GROUND_STRIP_TEXTURE_FALLBACK_PATH: &str = "ground_strip.png";
const GROUND_CURTAIN_TEXTURE_PRIMARY_PATH: &str = "textures/ground_curtain.png";
const GROUND_CURTAIN_TEXTURE_FALLBACK_PATH: &str = "ground_curtain.png";
