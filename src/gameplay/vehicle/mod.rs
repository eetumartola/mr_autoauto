...
const PLAYER_WHEEL_SPREAD_EXTRA_TOTAL_RADII: f32 = 0.2;
const PLAYER_WHEEL_SPREAD_EXTRA_PER_SIDE_M: f32 =
    PLAYER_WHEEL_RADIUS_M * PLAYER_WHEEL_SPREAD_EXTRA_TOTAL_RADII * 0.5;
const PLAYER_CHASSIS_RAISE_EXTRA_M: f32 = PLAYER_WHEEL_RADIUS_M * PLAYER_WHEEL_SPREAD_EXTRA_TOTAL_RADII;
